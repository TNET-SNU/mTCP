...
uint8_t *
mtcp_SSL_get_client_key(mtcp_SSL *ssl);

uint8_t *
mtcp_SSL_get_server_key(mtcp_SSL *ssl);

uint8_t *
mtcp_SSL_get_client_iv(mtcp_SSL *ssl);

uint8_t *
mtcp_SSL_get_server_iv(mtcp_SSL *ssl);

uint64_t
mtcp_SSL_get_tls_seq(mtcp_SSL *ssl);

uint64_t
mtcp_SSL_get_tls_ack(mtcp_SSL *ssl);
...
int
mtcp_SSL_create_tls_meta(mtcp_SSL *ssl, uint16_t cipher_suite, struct tls_meta *);
